...
#--- About Us ---#
    ...
    # 1/2 Message dans la section About Us
('Vannyssa', '2024-03-06 18:10:01',"WELCOME EVERYONE ! La Platforme, the leading digital school for all ! Built on a partnership with employers and social actors in the region, La Platforme, a digital and new technology school, has committed to enhancing the employability and professional integration of residents in the cities where it operates. It offers quality training in digital professions, open to all, regardless of resources or diplomas, and accessible throughout life. Present in Marseille, Toulon, Cannes and in Martigues, the school continues its development and holds a strong ambition for 2025/2026 with the opening of a brand-new campus capable of accommodating 3000 students. Unlock your potential by joining La Plateforme !", 1);
    ...
    # 2/2 A Modifier dans le terminal MYSQL
UPDATE message
SET name = "Vannyssa"
WHERE id = 1;

UPDATE message
SET time = '2024-03-06 18:10:01'
WHERE id = 1;

UPDATE message
SET message = "WELCOME EVERYONE ! La Platforme, the leading digital school for all ! Built on a partnership with employers and social actors in the region, La Platforme, a digital and new technology school, has committed to enhancing the employability and professional integration of residents in the cities where it operates. It offers quality training in digital professions, open to all, regardless of resources or diplomas, and accessible throughout life. Present in Marseille, Toulon, Cannes and in Martigues, the school continues its development and holds a strong ambition for 2025/2026 with the opening of a brand-new campus capable of accommodating 3000 students. Unlock your potential by joining La Plateforme !"
WHERE id = 1;
...
# 1/2 Message dans la section Rules
...
UPDATE message
SET time = '2024-03-06 18:20:02'
WHERE id = 2;

UPDATE message
SET message = 'OUR RULES | You must respect all members of the server | Your language must be appropriate for all members | Advertising is prohibited here, whether it be verbal, written, via private message, or even in any other ways | Pornographic, religious, and political content, as well as discriminatory remarks, will result in a permanent ban | Inappropriate usernames and profile pictures (pornography, advertising, offensive material, etc.) are prohibited.'
WHERE id = 2;
...
# 1/2 Message dans la section News
...
# 1/2 Message dans la section AI
('Inessa', '2024-03-06 19:10:11',"Hey guys, have you heard about the different specialties offered at LaPlateforme school ?", 7),
('Vanny', '2024-03-06 19:10:12',"Yeah, I was checking out their website earlier. They've got quite a range: cybersecurity, AI, software, web development, immersive systems and digital imaging.", 7),
...
# 1/2 Message dans la section Logiciel
('Inessa', '2024-03-06 20:11:21',"Hey guys, I wanted to share something with you. I've decided to specialize in AI for my studies.", 5),
('Vannyssa', '2024-03-06 20:12:22',"Oh, that's awesome! What made you choose AI ?", 5),
('Inessa', '2024-03-06 20:13:23',"Well, I've always been fascinated by data analysis, and AI seems to be at the forefront of that. Plus, it's such a promising field for the future, you know?", 5),
('Lucassa','2024-03-06 20:14:24'," Absolutely! The potential of AI is incredible. It's reshaping so many industries and opening up new possibilities.", 5),
...
# 1/2 Message dans la section Light Side
...
# 1/2 Message dans la section Dark Side
