...
class Contact(Gui, Client):
    ...
    def design(self):
        ...
        # Pin section
        self.hover_image("Cannes","Cannes", 1045, 495, 25, 25,"laplateforme_contact/contact12","laplateforme_contact/contact12") # Cannes
        self.hover_image("Toulon","Toulon", 1020, 510, 25, 25,"laplateforme_contact/contact12","laplateforme_contact/contact12") # Toulon
        self.hover_image("Marseille", "Marseille", 990, 500, 25, 25,"laplateforme_contact/contact12","laplateforme_contact/contact12") # Marseille  
        self.hover_image("Martigues","Martigues", 980, 495, 25, 25,"laplateforme_contact/contact12","laplateforme_contact/contact12")  # Martigues
