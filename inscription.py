...
class Inscription(Element,Screen):
    ...
    def form(self):
        ...
        self.button("pseudo", 600, 240, 400, 40, self.grey2, self.grey2, self.grey2, self.grey2,self.pseudo, self.font2, self.white, 15, 4, 5)
        
        # Email
        self.email_rect = self.rect_full(self.grey2, 600, 300, 400, 40, 5)
        self.button("email", 600, 300, 400, 40, self.grey2, self.grey2, self.grey2, self.grey2,self.email, self.font2, self.white, 15, 4, 5)
        
         # Prenom
        self.surname_rect = self.rect_full(self.grey2, 600, 360, 400, 40, 5)
        self.button("name", 600, 360, 400, 40, self.grey2, self.grey2, self.grey2, self.grey2,self.surname, self.font2, self.white, 15, 4, 5)
        
        # Nom
        self.name_rect = self.rect_full(self.grey2, 600, 420, 400, 40, 5)
        self.button("name", 600, 420, 400, 40, self.grey2, self.grey2, self.grey2, self.grey2,self.name, self.font2, self.white, 15, 4, 5)
        
        # Mot De Passe
        self.password_rect = self.rect_full(self.grey2, 600, 480, 400, 40, 5)
        self.button("password", 600, 480, 400, 40, self.grey2, self.grey2, self.grey2, self.grey2,self.password, self.font2, self.white, 15, 4, 5)
